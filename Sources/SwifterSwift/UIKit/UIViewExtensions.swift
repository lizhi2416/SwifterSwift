...
public extension UIView {
    ...
    @IBInspectable var ss_borderColor: UIColor? {
        get {
    ...
    @IBInspectable var ss_borderWidth: CGFloat {
        get {
    ...
    @IBInspectable var ss_shadowColor: UIColor? {
        get {
    ...
    @IBInspectable var ss_shadowOffset: CGSize {
        get {
    ...
    @IBInspectable var ss_shadowOpacity: Float {
        get {
    ...
    @IBInspectable var ss_shadowRadius: CGFloat {
        get {
